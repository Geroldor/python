...
panel = pygame.image.load("sprites/panel.png").convert_alpha()
sword_icon = pygame.image.load("sprites/sword.png").convert_alpha()
...
class Hero:
    def __init__(self, name, health, strength, defense):
        ...
        self.image_list = []
        # Idle sprites
        self.image_idle_list = [pygame.image.load("sprites/Warrior/Individual/idle/Warrior_Idle_1.png"), pygame.image.load("sprites/Warrior/Individual/idle/Warrior_Idle_2.png"), pygame.image.load("sprites/Warrior/Individual/idle/Warrior_Idle_3.png"), pygame.image.load("sprites/Warrior/Individual/idle/Warrior_Idle_4.png"), pygame.image.load("sprites/Warrior/Individual/idle/Warrior_Idle_5.png"), pygame.image.load("sprites/Warrior/Individual/idle/Warrior_Idle_6.png")]
        ...
        for i in range(12):
            self.image_attack_list.append(pygame.image.load("sprites/Warrior/Individual/Attack/Warrior_Attack_" + str(i + 1) + ".png"))
        ...
        for i in range(11):
            self.image_death_list.append(pygame.image.load("sprites/Warrior/Individual/DeathnoEffect/Warrior_Death_" + str(i + 1) + ".png"))
...
class knight:
    def __init__(self, name, health, strength, defense):
        ...
        self.image_idle_list = [pygame.image.load("sprites/enemy/Bringer-Of-Death/Idle/Bringer-of-Death_Idle_1.png"), pygame.image.load("sprites/enemy/Bringer-Of-Death/Idle/Bringer-of-Death_Idle_2.png"), pygame.image.load("sprites/enemy/Bringer-Of-Death/Idle/Bringer-of-Death_Idle_3.png"), pygame.image.load("sprites/enemy/Bringer-Of-Death/Idle/Bringer-of-Death_Idle_4.png"), pygame.image.load("sprites/enemy/Bringer-Of-Death/Idle/Bringer-of-Death_Idle_5.png"), pygame.image.load("sprites/enemy/Bringer-Of-Death/Idle/Bringer-of-Death_Idle_6.png"), pygame.image.load("sprites/enemy/Bringer-Of-Death/Idle/Bringer-of-Death_Idle_7.png"), pygame.image.load("sprites/enemy/Bringer-Of-Death/Idle/Bringer-of-Death_Idle_7.png")]
        
        for i in range(len(self.image_idle_list)):
            self.image_idle_list[i] = pygame.transform.scale(self.image_idle_list[i], ((self.image_idle_list[i].get_width() * 3), (self.image_idle_list[i].get_height() * 3)))
        self.image_attack_list = []
        for i in range(10):
            self.image_attack_list.append(pygame.image.load("sprites/enemy/Bringer-Of-Death/Attack/Bringer-of-Death_Attack_" + str(i + 1) + ".png"))
        for i in range(len(self.image_attack_list)):
            self.image_attack_list[i] = pygame.transform.scale(self.image_attack_list[i], ((self.image_attack_list[i].get_width() * 3), (self.image_attack_list[i].get_height() * 3)))
        self.image_list = self.image_idle_list
